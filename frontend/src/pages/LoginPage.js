      ...
      <div className="auth-container">
        ...
        <div className="auth-sidebar">
          ...
          <div style={{ textAlign: "center", margin: "40px 0", flex: 1, display: "flex", flexDirection: "column", justifyContent: "center" }}>
            ...
            <h1 style={{ fontSize: "24px", fontWeight: "800", color: "var(--text-primary)", marginBottom: "12px" }}>Welcome Back</h1>
            <p style={{ color: "var(--text-secondary)", fontSize: "14px", lineHeight: "1.7" }}>
              Sign in to manage your tasks, track your progress, and boost your productivity.
            </p>
